...
const std::string fname="/home/quang_le/Documents/Michigan/Third_semester/ME590/ros2_mod_ws/src/hello/scripts/mpc_rover_state_obs_avoid_1710_13.txt";  //just a directory, please change
...
// const std::vector<double>& scan_ranges;
  ...
  MPCProblem(double x_init, double y_init, double yaw_init, 
             double x_goal, double y_goal, std::vector<std::vector<double>> obs_list)
